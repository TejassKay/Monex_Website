...
export const metadata: Metadata = {
  title: "Classic Series Power Tools | Monex Official Catalogue",
  description: "Monex Classic Series power equipment featuring industry-standard CM4 cutters, angle grinders, heat guns, blowers, polishers, and demolition hammers.",
};

export default function ClassicSeriesPage() {
  const products = (catalogueData.products as Product[]).filter(
    (p) => p.category === "power-tools" && p.series === "Classic Series"
  );
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-monex-border p-6 rounded-sm space-y-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-monex-black uppercase tracking-tight">
            Monex Classic Series
          </h1>
          <p className="text-slate-600 text-xs sm:text-sm max-w-2xl leading-relaxed">
            Reliable, workhorse power tools for stone cutting, grinding, drilling, polishing, and site cleaning.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="text-xs font-mono text-slate-600">
            Showing all {products.length} Classic Series products
          </div>
