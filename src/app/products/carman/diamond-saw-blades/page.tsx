...
export const metadata: Metadata = {
  title: "CARMAN Diamond Saw Blades | Monex Official Catalogue",
  description: "Browse CARMAN high-speed diamond saw blades, ultra-thin zero-chip cutters, 9T PRO, 16T PRO, and heavy cutting blades.",
};

export default function CarmanSawBladesPage() {
  const products = (catalogueData.products as Product[]).filter(
    (p) => (p.category === "carman" || p.category === "diamond-tools") && p.subcategory === "DIAMOND SAW BLADES"
  );
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-monex-border p-6 rounded-sm space-y-2">
          ...
          <p className="text-slate-600 text-xs sm:text-sm max-w-2xl leading-relaxed">
            High-precision diamond saw blades designed for marble, granite, ceramic tiles, and stone slabs with zero-chip technology.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="text-xs font-mono text-slate-600">
            Showing all {products.length} Diamond Saw Blades
          </div>
