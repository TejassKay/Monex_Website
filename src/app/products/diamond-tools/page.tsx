...
export const metadata: Metadata = {
  title: "Diamond Tools & Cutting Accessories | Monex",
  description: "Monex high-precision diamond saw blades, ultra-thin zero-chip cutters, wood blades, electroplated blades, and specialized grooving cutters.",
};
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-monex-border p-6 rounded-sm space-y-2">
          ...
          <p className="text-slate-600 text-xs sm:text-sm max-w-2xl leading-relaxed">
            High-precision diamond saw blades, ultra-thin zero-chip cutters, wood saw blades, and specialized V/C/U grooving cutters.
          </p>
        </div>
